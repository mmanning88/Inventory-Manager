...
public class AddProductController implements Initializable {
    ...
    void onActionSaveProduct(ActionEvent event) throws IOException {
        ...
        if (price == 0) {
            ...
            alert.setContentText("Products must have a price greater than 0");
            alert.showAndWait();
            return;
        }
        ...
        Product productToAdd = new Product(id, stock, min, max, name, price);
        productToAdd.setAssociatedParts(partsToSave);
    ...
    void onActionToMainMenu(ActionEvent event) throws IOException {
        ...
        alert.setTitle("Cancel Add Product Confirmation");
        alert.setContentText("Are you sure?");
        Optional<ButtonType> result = alert.showAndWait();
        if (result.get() == ButtonType.OK) {
            
            cancelProductCountID();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        newProductID = Inventory.getProductCountID();
        productIDTxt.setText(Integer.toString(newProductID));
