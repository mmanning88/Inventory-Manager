An inventory management application using Java. JavaFX and Scene Builder used for GUI.

Satisfies all requirements for C482 Software I at Western Governer's University.
